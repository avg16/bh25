...
class CholecT50Dataset(object):
    ...
    def show_image_and_labels(self, frameid):
        ...
        for label in labels:
            ...
            draw.text((st, (y0+y1)//2), text, fill="yellow", align="center", font=font)
        img.show()
...
if __name__=="__main__":
    ...
    parser.add_argument('-l', '--list-frames', action='store_true', help='To display the IDs of all image frames in the video directory.')
    parser.add_argument('--frameid', type=int, default=-1, help='provide the frame iD (int) to visualize.') 
    parser.add_argument('-sl', '--show-label', action='store_true', help='To display the labels of image of the provided frame ID.')
    parser.add_argument('-si', '--show-image', action='store_true', help='To display the image of the provided frame ID.')
    parser.add_argument('-sil', '--show-image-and-label', action='store_true', help='To display an image with the corresponding labels of the provided frame ID.') 
